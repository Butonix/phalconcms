                        ...
                        <div class="col-md-4">
                            <div class="row">
                                ...
                                <div style="float: left;">
                                    <div class="image_preview" onclick="openFileBrowser(this)">
										<img src="{% if slideShow is defined and slideShow.image|length %}{{ _baseUri }}/{{ slideShow.image }}{% else %}{{ _baseUri }}/media/default/select-image.png{% endif %}" style="width: 250px; border: 1px solid #c0c0c0; padding: 2px; border-radius: 3px">
                                    </div>
            ...
            $('[required]').each(function() {
                if($(this).val() == '') {
                    ...
                    if($(this).parent().find('.help-block').length == 0) {
                        $(this).parent().append('<span class="help-block">{{ __('form_this_field_is_required') }}</span>');
                    } else {
