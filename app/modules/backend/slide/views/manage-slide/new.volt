        ...
        <form action="{{ _baseUri }}{{ router.getRewriteUri() }}" method="post" id="adminForm" enctype="multipart/form-data">
            <div class="panel panel-default">
                <div class="panel-body buttons-widget">
                    ...
                    <div class="col-md-4">
                        <div class="row">
                            <label class="control-label">{{ __('m_slide_form_slide_show_item_form_image') }}</label>

                            <div class="clearfix"></div>
                            <div style="float: left">
                                <div class="product_image_preview" onclick="openFileBrowser(this)">
									<img src="{{ _baseUri }}{% if slideShowItems is defined and slideShowItems.image|length %}{{ slideShowItems.image }}{% else %}/media/default/no-image.png{% endif %}" style="width: 250px; border: 1px solid #c0c0c0; padding: 2px; border-radius: 3px">
                                </div>
