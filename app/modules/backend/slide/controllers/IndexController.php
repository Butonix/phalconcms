...
use Backend\Slide\Forms\SlideShowForm;
...
class IndexController extends BackendController
{
     ...
     */
    public $_model = 'Core\Models\SlideShows';
    ...
    public function editAction($id)
    {
        ...
        if($this->request->isPost()) {
            if($form->isValid($_POST, $slideShow)) {
                if($slideShow->save()) {
                    $imageStatus = ImageHelper::uploadImages(
    ...
    public function newAction()
    {
        ...
        if($this->request->isPost()) {
            ...
            if($form->isValid($_POST, $slideShow)) {
                if($slideShow->save()) {
                    $imageStatus = ImageHelper::uploadImages($this->request->getUploadedFiles(), self::SLIDE_SHOW_FOLDER_UPLOAD . '/' . $slideShow->slide_show_id, 'image');
                    if($imageStatus['status']) {
                        $slideShow->image = $imageStatus['imageUrl'];
                        $slideShow->save();
                    } else {
