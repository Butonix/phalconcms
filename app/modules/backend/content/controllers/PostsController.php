...
namespace Backend\Content\Controllers;

use Backend\Content\Forms\PostForm;
...
class PostsController extends BackendController
{
    ...
    public function indexAction()
    {
        ...
        $items = $this->modelsManager->createBuilder()
            ...
            ->addFrom('Core\Models\Posts', 'p')
            ->join('Core\Models\Users', 'p.created_by = u.user_id', 'u')
            ->leftJoin('Core\Models\PostCategory', 'p.category_id = c.category_id', 'c')
