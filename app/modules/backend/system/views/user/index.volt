                    ...
                    <div class="row toolbar-helper">
                            ...
                            <div class="dataTables_length">
                                <div class="input-group input-group-sm">
                                    ...
                                    <span class="input-group-btn">
                                        <input type="reset" class="btn btn-danger btn-sm" value="{{ __('reset_button') }}" onclick="return Core.resetFilter();">
                                        {{ submit_button("go", "value": __('go_button'), "class" : "btn btn-primary btn-sm") }}
                                    </span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-7">
                            <div class="dataTables_filter">
                                <label>{{ select_static("filter_role", rolesData, "value" : _filter['filter_role'], "class" : "form-control input-sm", "onchange" : "Core.submitForm()") }}</label>
                            </div>
                        </div>
                    </div>
