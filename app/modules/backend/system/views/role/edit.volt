                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <td>{{ select('is_default',['0' : __('no'), '1' : __('yes')],'class' : 'form-control', 'value' : edit_data.is_default) }}</td>
                            </tr>
                            <tr>
                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-6 text-right">
                            <button type="button" class="btn btn-success btn-sm role_collapse_all">{{ __('m_admin_system_help_text_collapse_all') }}</button>
                            <button type="button" class="btn btn-warning btn-sm role_expand_all">{{ __('m_admin_system_help_text_expand_all') }}</button>
                        </div>
