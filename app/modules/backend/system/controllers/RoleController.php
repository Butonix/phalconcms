...
use Core\Models\UserRules;
use Core\Models\UserRoleMapping;
...
class RoleController extends BackendController
{
    public function indexAction()
    {
        ...
        $items = $this->modelsManager->createBuilder()
            ...
            ->addFrom('Core\Models\UserRoles', "ar")
        ...
        // Create pagination
        $this->view->setVar('_page', Pagination::getPaginationQueryBuilder($items, $paginationLimit, $currentPage));
    ...
    private function _addCSSAndJS(){
        // Add css
        $this->assets->collection('css_header')->addCss('/plugins/dynatree/skin-vista/ui.dynatree.css');
        // Add js
        $this->assets->collection('js_footer')->addJs('/plugins/dynatree/jquery.dynatree.min.js');
    }
    ...
    private function updateRules()
    {
        ...
        foreach($core_module as $cModule) {
            $filePath = APP_PATH . '/modules/backend/' . $cModule->base_name . '/Resource.php';
        ...
        $allModuleBackEnd = get_child_folder(APP_PATH . '/modules/backend/');
    ...
    private function deleteOldRules($module, $rules)
    {
        ...
        $phql = "SELECT "
            . "rule_id,mca FROM Core\Models\UserRules "
