...
class LanguageController extends BackendController
{
     ...
     */
    public $_model = 'Core\Models\CoreLanguages';
    ...
    public function indexAction()
    {
        $this->_toolbar->addCustomButton('system|language|setDefaultLanguage',
            ...
            'return Core.customSubmit(this,\'' . __('m_system_language_message_do_you_wan_set_default_language') . '\',\'' . __('please_select_item_to_set_default_language') . '\');'
        );
