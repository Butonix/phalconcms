<div class="row cms-paginate" style="padding: 0 10px">
    <div class="col-md-6">
        <div class="dataTables_info">{{ __("you_are_in_current_page_per_page", ["1" : page.current, "2" : page.total_pages]) }}</div>
    </div>
    <div class="col-md-6">
            ...
            <div class="dataTables_paginate paging_bootstrap" style="height: 35px">
                <ul class="pagination">
                    ...
                    {% if page.current < page.total_pages %}
                        ...
                        <li>
                            <a data-content="{{ request_link }}{{ page.next }}{{ page.last }}{{ request_title }}">{{ __('last') }}</a>
                        </li>
                    {% endif %}
                </ul>
            </div>
