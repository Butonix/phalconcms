            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-body">
                        <form action="{{ _baseUri }}{{ router.getRewriteUri() }}" method="post" id="adminForm" novalidate="novalidate" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    {{ form.render("link") }}
                                    <br/>
                                    <a data-target="#ajax-modal-menu" href="{{ _baseUri }}/admin/menu/router/menu/" data-toggle="modal" class="btn btn-success btn-sm"><span class="fa fa-link"></span> Choose Menu</a>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <div class="fileupload fileupload-new" data-provides="fileupload">
                                        ...
                                        <div class="fileupload-preview fileupload-exists thumbnail" style="height: 150px; line-height: 10px;"></div>
                                        <div>
    ...
    <script type="text/javascript">
        ...
        function getModalContainer(container) {
            ...
            el.block({
                ...
                message: '<img src="{{ _baseUri }}/images/tmp/loading.gif" /> {{ __('loading') }}...',
                css: {
                    border: 'none',
                    color: '#333',
                    background: 'none'
