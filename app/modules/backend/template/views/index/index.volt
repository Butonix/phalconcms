                ...
                <div class="row cms-toolbar-helper">
                            ...
                            <div class="input-group input-group-sm">
                                ...
                                {#<span class="input-group-btn">#}
                                    {#<input type="reset" class="btn btn-danger btn-sm"#}
									   {#value="{{ __('reset_button') }}" onclick="return Core.resetFilter();">#}
                    ...
                    <div class="col-md-7">
                        <div class="dataTables_filter">
                            <label>{{ select_static("filter_location", filter_location, "value" : _filter['filter_location'], "class" : "form-control", "onchange" : "Core.submitForm()") }}</label>
                        </div>
                    </div>
                </div>
