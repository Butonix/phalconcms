...
INSERT INTO `core_templates` (`base_name`, `name`, `location`, `uri`, `description`, `author`, `authoruri`, `tag`, `version`, `published`) VALUES
  ('default', 't_template_backend_name_default', 'backend', 'http://phalconcmf.com', 't_template_backend_name_default_desc', 'Lexnet.cn', NULL, 'red, e-commerce, lexnet.cn', '1.0.0', 1),
  ('default', 't_template_frontend_name_default', 'frontend', 'http://phalconcmf.com', 't_template_frontend_name_default_desc', 'Lexnet.cn', NULL, 'red, lexnet.cn', '1.0.0', 1);
##SQL##
