...
<head>
    ...
    <!-- Install CSS -->
    <link href="{{ _baseUri }}/templates/backend/default/css/install.css" rel="stylesheet" type="text/css"/>
...
<div class="install-box">
            ...
            <form action="{{ _baseUri }}/install.php?step=2" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        {{ text_field('dbname', 'class' : 'form-control', 'value' : 'phalconcms') }}
                    </div>
                </div>
                <div class="form-group">
    ...
    <div class="row">
        ...
        <p class="text-center">Phalcon CMS | Power by on Phalcon Framework 2!</p>
    </div>
</div>

<!-- jQuery 2.1.4 -->
<script src="{{ _baseUri }}/plugins/jquery/jquery-1.12.2.min.js"></script>
<!-- Bootstrap 3.3.2 JS -->
