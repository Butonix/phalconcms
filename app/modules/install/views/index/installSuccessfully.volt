...
<head>
    ...
    <!-- Theme style -->
    <link href="/templates/backend/default/AdminLTE/css/AdminLTE.min.css" rel="stylesheet" type="text/css"/>
    <!-- iCheck -->
    <link href="/plugins/iCheck/square/blue.css" rel="stylesheet" type="text/css"/>
    <!-- Install CSS -->
    <link href="/templates/backend/default/css/install.css" rel="stylesheet" type="text/css"/>
