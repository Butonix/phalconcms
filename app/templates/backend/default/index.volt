...
<head>
    ...
    <!-- Theme style -->
    <link href="{{ _baseUri }}/templates/backend/default/AdminLTE/css/AdminLTE.min.css" rel="stylesheet" type="text/css"/>
    <!-- AdminLTE Skins. Choose a skin from the css/skins folder instead of downloading all of them to reduce the load. -->
    <link href="{{ _baseUri }}/templates/backend/default/AdminLTE/css/skins/_all-skins.min.css" rel="stylesheet" type="text/css"/>
    <!-- Phalcon CMS custom -->
    <link href="{{ _baseUri }}/templates/backend/default/css/custom.css" rel="stylesheet" type="text/css"/>

    <!-- Coder css -->
    {{ assets.outputCss('css_header') }}
	<!-- End Coder css -->
    ...
    <!--[if lt IE 9]>
    <script src="{{ _baseUri }}/plugins/html5shiv/html5shiv.min.js"></script>
    <script src="{{ _baseUri }}/plugins/respond/respond.min.js"></script>
    <![endif]-->
</head>
	...
	<div class="wrapper">
		<header class="main-header">
			...
			<a href="{{ _baseUri }}/" class="logo" target="_blank">
				...
				<span class="logo-mini">{{ _shortName }}</span>
		...
		<footer class="main-footer">
			<div class="pull-right hidden-xs">
				<b><a href="http://phalconphp.com/">Phalcon 2 Framework</a> &amp; <a href="https://almsaeedstudio.com/">AdminLTE</a></b> 2.3.2
			</div>
			<strong>Copyright <a href="http://phalconcmf.com">&copy; Lexnet.cn</a> {{ date('Y') }}</strong> - <i>Version {{ _version }}</i> .All rights reserved.
		</footer>
	</div>
	<!-- ./wrapper -->
	
	<!-- jQuery -->
	<script src="{{ _baseUri }}/plugins/jquery/jquery-1.12.2.min.js" type="text/javascript"></script>
	<script src="{{ _baseUri }}/plugins/jquery-ui/jquery-ui-1.11.4.min.js" type="text/javascript"></script>
	<!-- Bootstrap JS -->
	<script src="{{ _baseUri }}/plugins/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
	<!-- AdminLTE App -->
	<script src="{{ _baseUri }}/templates/backend/default/AdminLTE/js/app.min.js" type="text/javascript"></script>
	<script src="{{ _baseUri }}/plugins/slimScroll/jquery.slimscroll.min.js" type="text/javascript"></script>
	<!-- Pace -->
	<script src="{{ _baseUri }}/plugins/pace/pace.min.js" type="text/javascript"></script>
	<!-- Phalcon CMS JS -->
	<script src="{{ _baseUri }}/templates/backend/default/js/custom.js" type="text/javascript"></script>
	<!-- Coder JS -->
