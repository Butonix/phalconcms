...
class FormFilter
{
    ...
    public function addTextElement($name, $attributes)
    {
        if(!isset($attributes['class'])) {
            $attributes['class'] = 'form-control input-sm form-filter';
        } else {
            $attributes['class'] .= ' date-picker form-control input-sm form-filter';
        }
    ...
    {
        if(!isset($attributes['class'])) {
            $attributes['class'] = 'form-control date-picker input-sm form-filter';
        } else {
            $attributes['class'] .= ' form-control date-picker input-sm form-filter';
        }
    ...
    public function addDateElement($name, $attributes)
    {
        ...
        // Add attribute date format
        $attributes['data-date-format'] = __('full_date_format');
    ...
    public function addPriceRangeElement($name, $attributes)
    {
        ...
        // Add placeholder
        $attributes['placeholder'] = __('price_from');
        $attributes['value'] = $attributes['value_from'];
        $elementPriceFrom = new Text($name . '_from', $attributes);

        // Add placeholder
        $attributes['placeholder'] = __('price_to');
        $attributes['value'] = $attributes['value_to'];
    ...
    public function addNumberRangeElement($name, $attributes)
    {
        ...
        // Add placeholder
        $attributes['placeholder'] = __('number_from');
        $attributes['value'] = $attributes['value_from'];
        $elementPriceFrom = new Text($name . '_from', $attributes);

        // Add placeholder
        $attributes['placeholder'] = __('number_to');
        $attributes['value'] = $attributes['value_to'];
        $elementPriceTo = new Text($name . '_to', $attributes);
