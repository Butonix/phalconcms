...
{
    /**
     * @var \Phalcon\Mvc\Model|NestedSet;
     */
    private $owner;
     ...
     *
     * @param  NestedSet $target the target.
     * @param  array $attributes list of attributes.
     *
     * @return boolean                     whether the prepending succeeds.
     */
    ...
    /**
     * @param  \Phalcon\Mvc\ModelInterface|NestedSet $target
     * @param  int $key
     * @param  int $levelUp
     *
     * @return boolean
