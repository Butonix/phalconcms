...
class BackendController extends Controller
{
    ...
    public function initialize()
    {
        ...
        // Add toolbar helper
        $this->_toolbar = ToolbarHelper::getInstance($this->_module, $this->_controller);
    ...
    protected function _initBasicViewVariables()
    {
        ...
        // Set system name
		$this->view->setVar('_shortName', $this->config->website->shortName);
    ...
    public function publishAction($id = null, $redirect = null, $log = true)
    {
        if($this->_model && $this->_modelBaseName && $this->_modelPrimaryKey) {
            ...
            $this->flashSession->error('message_you_must_set_model_in_child_controller');
        }
        if($redirect) {
    ...
    public function getFilter()
    {
        ...
        $filterSessionGlobal = new SessionBag('GB_FILTER');
        $filterSession = [];
